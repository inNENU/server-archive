...
$listContent = preg_replace(
    '/[\n\r\t]*/',
    '',
    Http_get("http://mid.nenu.edu.cn:8080/xxhbwx/HttpReq?url=www.nenu.edu.cn/_s4/tzggwmhzqw/list1.psp&appid=2")
);
